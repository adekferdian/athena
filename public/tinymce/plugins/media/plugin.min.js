...
!(function () {
        ...
        start: function (e, t) {
          if (!c.get())
            if (J(t.map, 'data-ephox-embed-iri'))
              ...
              'source' === e &&
                (s.source ? s.altsource || (s.altsource = t.map.src) : (s.source = t.map.src)),
        ...
        !(function (e, t) {
          ...
          if (o.map[t])
            for (var n = o.length; n--; ) {
              var a = o[n]
              a.name === t &&
                (r ? ((o.map[t] = r), (a.value = r)) : (delete o.map[t], o.splice(n, 1)))
            }
                ...
                if (s)
                  switch (e) {
                    ...
                    case 'iframe':
                      ...
                      break
                    case 'source':
                      if (d < 2 && (O(t, {src: c[te[d]], type: c[te[d] + 'mime']}), !c[te[d]]))
                        return
                      d++
                      break
                    case 'img':
              ...
              if ('video' === e && s)
                for (var t, r = 0; r < 2; r++)
                  c[te[r]] &&
                    (((t = []).map = {}),
                    d <= r &&
                      (O(t, {src: c[te[r]], type: c[te[r] + 'mime']}), l.start('source', t, !0)))
              var n
              c.poster &&
                'object' === e &&
                s &&
    ...
    return (
      ...
      'iframe' === n.type
        ...
        ? ((u =
          ...
          n.poster &&
            (u +=
              '<img src="' + n.poster + '" width="' + n.width + '" height="' + n.height + '" />'),
          u + '</object>')
  ...
  function C(e, t) {
    ...
    return c
      ? ((a = t),
        ...
        new ne(function (t, e) {
          function r(e) {
            return e.html && (ae[a.source] = e), t({url: a.source, html: e.html || o(a)})
          }
  ...
  function F(a, o) {
    return function (e) {
      ...
      i(e.url) &&
        0 < e.url.trim().length &&
        ((t = e.html), (r = M(o, t)), (n = p(p({}, r), {source: e.url, embed: t})), a.setData(P(n)))
    }
  }
  function z(e, t) {
        ...
        switch (t.name) {
          case 'source':
            ;(u = d.get()),
              ...
              u.source !== l.source &&
                (F(h, m)({url: l.source, html: ''}), C(m, l).then(F(h, m)).catch($(m)))
            break
          case 'embed':
  ...
  function L(e, t) {
    ...
    R(t, i, o),
      ...
      'iframe' === r
        ...
        : (h(
            ['controls', 'crossorigin', 'currentTime', 'loop', 'muted', 'poster', 'preload'],
            function (e) {
              i.attr(e, t.attr(e))
            }
          ),
          s((a = n.attr('data-mce-html'))) &&
            (function (e, t, r, n) {
              for (
                var a = ce({forced_root_block: !1, validate: !1}, e.schema).parse(n, {context: t});
                a.firstChild;
    ...
    se = function (e, t, r) {
      for (var n = t.attributes, a = n.length; a--; ) {
        ...
        'width' !== o &&
          'height' !== o &&
          'style' !== o &&
          (('data' !== o && 'src' !== o) || (i = e.convertURL(i, o)), r.attr('data-mce-p-' + o, i))
      }
              ...
              for (var t, r, n, a, o, i, c, s = e.length; s--; )
                (t = e[s]).parent &&
                  (t.parent.attr('data-mce-object') ||
                    ...
                    ('iframe' === (c = t.name) || 'video' === c || 'audio' === c) &&
              ...
              if ((r = e[l]).parent) {
                for (
                  s = r.attr(t),
                    ...
                    'audio' !== s &&
                      'script' !== s &&
                      ((u = r.attr('class')) && -1 !== u.indexOf('mce-preview-object')
                        ? n.attr({
