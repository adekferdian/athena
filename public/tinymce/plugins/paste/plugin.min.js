            ...
            return (
              he.each(e, function (e, t) {
                ...
                0 !== t.indexOf('mso-comment')
                  ? 0 !== t.indexOf('mso-') && ('all' === g(r) || (a && a[t])) && (s[t] = e)
                  : o.remove()
              }),
              /(bold)/i.test(s['font-weight']) && (delete s['font-weight'], o.wrap(new Te('b', 1))),
              /(italic)/i.test(s['font-style']) && (delete s['font-style'], o.wrap(new Te('i', 1))),
        ...
        for (var t, n, r, a = e.length; a--; )
          (n = (t = e[a]).attr('href')),
            ...
            n && -1 !== n.indexOf('#_msocom_')
              ? t.remove()
              : (!(n = n && 0 === n.indexOf('file://') ? (n = n.split('#')[1]) && '#' + n : n) &&
                  !r) ||
          ...
          for (
            var a,
              ...
              t = function (e, t, n) {
                ...
                ;(a = r !== i ? (r < i ? a && a.parent.parent : ((o = a), null)) : a) &&
                a.name === t
                  ? a.append(e)
                  : ((o = o || a), (a = new Te(t, 1)), 1 < n && a.attr('start', '' + n), e.wrap(a)),
                  (e.name = 'li'),
    ...
    return (
      ...
      o.hasEventListeners('PastePostProcess') && !p.isDefaultPrevented()
        ? ((u = i),
          ...
          j(
            (d = l.fire('PastePostProcess', {node: f, internal: u, wordContent: c})).node.innerHTML,
  ...
  function N(e, t) {
    var n,
      ...
      u = x(
        ((n = l),
        (o =
          (r = e.getParam('paste_tab_spaces', 4, 'number')) <= 0 ? '' : new Array(r + 1).join(' ')),
        (i = n.replace(/\t/g, o)),
        (s = {
                    ...
                    !(m = t.getParam('images_dataimg_filter')) || m(p)
                      ? ((c = void 0),
                        (i = (o = t.editorUpload.blobCache).getByData(v, h))
                          ? (c = i)
                          : ((l = (s = t.getParam('images_reuse_filename') && P(b.name))
                              ? ((f = t),
                                P((d = b.name.match(/([\s\S]+?)(?:\.[a-z0-9.]+)$/i)))
                                  ? f.dom.encode(d[1])
                                  : null)
                              : y),
                            (u = s ? b.name : void 0),
    ...
    function d(e, t, n, r, a) {
      ...
      ;((r = !o.length || (m && !g) || r) || g) &&
                ...
                if ('br' !== t) {
                  if ('wbr' !== t)
                    if ((c[t] && (u += ' '), f[t])) u += ' '
                      ...
                      if ((3 === e.type && (u += e.value), !e.shortEnded && (e = e.firstChild)))
                        for (; p(e), (e = e.next); );
                      d[t] && n.next && ((u += '\n'), 'p' === t && (u += '\n'))
                    }
                } else u += '\n'
        ...
        v.isDefaultContent(o)
          ? n ||
            e.windowManager.alert('Please use Ctrl+V/Cmd+V keyboard shortcuts to paste contents.')
          : r
          ? N(e, o)
          : L(e, o, a)
    }
    ;(s = o),
      ...
      s.on('paste', function (e) {
        ...
        ;(u = !1),
          e.isDefaultPrevented() ||
          ((n = e.clipboardData),
          -1 !== navigator.userAgent.indexOf('Android') && n && n.items && 0 === n.items.length) ||
          ...
          for (var a = e.length; a--; )
            (i = e[a].attr('src')) &&
              ((0 !== i.indexOf('webkit-fake-url') &&
                (o.getParam('allow_html_data_urls', !1, 'boolean') || 0 !== i.indexOf('data:'))) ||
    ...
    return {
      create: function () {
        return (function (e, t, n) {
          ...
          ;(pe.ie || pe.gecko) &&
            r.setStyle(u, 'left', 'rtl' === r.getStyle(a, 'direction', !0) ? 65535 : -65535),
