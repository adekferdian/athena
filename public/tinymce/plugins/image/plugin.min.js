...
!(function () {
    ...
    return S([
      ...
      [
        v(
          v(
            {},
            e.classList.isSome() && e.hasImageCaption ? {type: 'grid', columns: 2} : {type: 'panel'}
          ),
          {
            items: S([
              r.toArray(),
    ...
    c.block('Uploading image'),
      (0 < (e = n.fileinput).length ? L.some(e[0]) : L.none()).fold(
        ...
        function (n) {
          ...
          function i(e) {
            c.setData({src: {value: e, meta: {}}}), c.showTab('general'), de(l, s, t, c)
          }
    ...
    return function (e, t) {
      ...
      'src' === t.name
        ...
        ? ((o = S),
          ...
          (D = _(y((A = s).style))),
          ((w = xe({}, A)).vspace =
            D['margin-top'] && D['margin-bottom'] && D['margin-top'] === D['margin-bottom']
              ? O(String(D['margin-top']))
              : ''),
          (w.hspace =
            D['margin-right'] && D['margin-left'] && D['margin-right'] === D['margin-left']
                    ...
                    (r = e).hasAdvTab || r.hasUploadUrl || r.hasUploadHandler
                      ? {
                          ...
                          tabs: S([
                            [ke(r)],
                            r.hasAdvTab ? [Re(r)] : [],
                            r.hasUploadTab && (r.hasUploadUrl || r.hasUploadHandler) ? [Me(r)] : [],
                          ]),
                        }
  ...
  function he(a) {
    return function (e) {
      for (
        ...
        ;(r = i.attr('class')) &&
          /\bimage\b/.test(r) &&
          (i.attr('contenteditable', a ? 'false' : null), Te.each(i.getAll('figcaption'), n))
      }
    }
  }
  ...
  var ye,
    ...
    Ce = function (e, t, n) {
      ...
      ee(n, r, t, 'caption', function (e, t, n) {
        return (
          H((r = e))
            ...
            : ((i = r),
              ...
              Ue.insertAfter(a, i),
              a.appendChild(i),
              a.appendChild(Ue.create('figcaption', {contentEditable: 'true'}, 'Caption')),
        ...
        (t.alt === r.alt && t.isDecorative === r.isDecorative) || Ie(n, t.alt, t.isDecorative)
    },
    xe =
      ((ye = function (e, t) {
  ...
  o.add('image', function (e) {
    ...
    ;(t = e).on('PreInit', function () {
      ...
      n.ui.registry.addMenuItem('image', {icon: 'image', text: 'Image...', onAction: fe(n).open}),
