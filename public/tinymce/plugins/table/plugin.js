...
;(function () {
  ...
  var type = Adt.generate([{none: []}, {multiple: ['elements']}, {single: ['element']}])
  ...
  var Selections = function (lazyRoot, getStart, selectedSelector) {
    var get = function () {
      return retrieve(lazyRoot(), selectedSelector).fold(
        function () {
  ...
  var getCalculatedHeight = function (element, boxSizing) {
    ...
    return boxSizing === 'border-box'
      ? height
      : calcContentBoxSize(element, height, 'top', 'bottom')
  }
  ...
  var getHeight$1 = function (element) {
    return needManualCalc()
      ? getCalculatedHeight(element, getBoxSizing(element))
      : getProp(element, 'height', element.dom.offsetHeight)
  }
  var getWidth = function (element) {
    return needManualCalc()
      ? getCalculatedWidth(element, getBoxSizing(element))
  ...
  var getWidthFrom = function (warehouse, table, getWidth, fallback) {
    ...
    var backups = [Optional.some(width.edge(table))].concat(
      map$1(width.positions(columnCells, table), function (pos) {
  ...
  var getHeightFrom = function (warehouse, table, direction, getHeight, fallback) {
    ...
    var backups = [Optional.some(direction.edge(table))].concat(
      map$1(direction.positions(rows$1, table), function (pos) {
        return pos.map(function (p) {
          return p.y
        })
      })
  ...
  var adt$6 = Adt.generate([{invalid: ['raw']}, {pixels: ['value']}, {percent: ['value']}])
  ...
  var get$3 = function (editor, isResizable) {
    return editor.inline
      ? ResizeWire.body(getBody(editor), createContainer(), isResizable)
  ...
  var insert$1 = function (table, selector, element) {
    last$2(children$1(table, selector)).fold(
      function () {
  ...
  var toGrid = function (warehouse, generators, isNew) {
    ...
    each$2(warehouse.colgroups, function (colgroup) {
      ...
      for (var columnIndex = 0; columnIndex < warehouse.grid.columns; columnIndex++) {
        var element = Warehouse.getColumnAt(warehouse, columnIndex)
          .map(function (column) {
  ...
  var run = function (operation, extract, adjustment, postAction, genWrappers) {
    return function (wire, table, target, generators, behaviours) {
      var warehouse = Warehouse.fromTable(table)
      var tableSection = Optional.from(
  ...
  var rowReplacerPredicate = function (targetRow, columnHeaders) {
    ...
    return entireTableIsHeader
      ? always
      : function (cell, _rowIndex, colIndex) {
  ...
  var columnReplacePredicate = function (targetColumn, rowHeaders) {
    ...
    return entireTableIsHeader
      ? always
      : function (cell, rowIndex, _colIndex) {
          var type = name(cell.element)
  ...
  var replaceIn = function (
    ...
    return map$1(grid, function (row, rowIndex) {
      return mapCells(row, function (cell, colIndex) {
        if (isTarget(cell)) {
          var newCell_1 = shouldReplace(cell, rowIndex, colIndex)
  ...
  var opGetColumnsType = function (table, target) {
    ...
    return details
      .bind(function (selectedCells) {
        ...
        var selectedColumnCells = flatten$1(
          map$1(house.all, function (row) {
  ...
  var TableActions = function (editor, cellSelection, lazyWire) {
    ...
    var setSelectionFromAction = function (table, result) {
      return result.cursor.fold(
        function () {
          var cells = cells$1(table)
          return head(cells)
            .filter(inBody)
            .map(function (firstCell) {
    ...
    var execute = function (operation, guard, mutate, lazyWire, effect) {
      return function (table, target, noEvents) {
        ...
        return guard(table)
          ? operation(wire, table, target, generators, behaviours).bind(function (result) {
  ...
  var extractDataFromSettings = function (editor, hasAdvTableTab) {
    ...
    var getBorder = function () {
      ...
      return get$c(attrs, 'border').fold(
        function () {
          return {}
        },
        function (border) {
    ...
    var getCellPaddingCellSpacing = function () {
      var spacing = get$c(style, 'border-spacing')
        .or(get$c(attrs, 'cellspacing'))
        .fold(
          function () {
            return {}
          },
      ...
      var padding = get$c(style, 'border-padding')
        .or(get$c(attrs, 'cellpadding'))
        .fold(
          function () {
            return {}
          },
  ...
  var getRowType = function (elm) {
    return table(SugarElement.fromDom(elm))
      .map(function (table) {
  ...
  var extractDataFromTableElement = function (editor, elm, hasAdvTableTab) {
    ...
    var dom = editor.dom
    var cellspacing = shouldStyleWithCss(editor)
    ...
    var cellpadding = shouldStyleWithCss(editor)
  ...
  var registerCommands = function (editor, actions, cellSelection, selections, clipboard) {
    ...
    var setSizingMode = function (sizing) {
      return getSelectionStartCellOrCaption(editor).each(function (cellOrCaption) {
        var isForcedSizing =
          isResponsiveForced(editor) || isPixelsForced(editor) || isPercentagesForced(editor)
        if (!isForcedSizing) {
  ...
  var registerQueryCommands = function (editor, actions, selections) {
    ...
    var lookupOnSelection = function (action) {
      return getSelectionCell(getSelectionStart(editor))
        .bind(function (cell) {
  ...
  var searchFromPoint = function (doc, x, y) {
    return SugarElement.fromPoint(doc, x, y).bind(function (elem) {
      ...
      return children$3(elem).length === 0
        ? fallback()
  ...
  var doGetExact = function (selection) {
    if (selection.anchorNode === null || selection.focusNode === null) {
      ...
      return after$2(anchor, selection.anchorOffset, focus_1, selection.focusOffset)
        ? Optional.some(
            SimRange.create(anchor, selection.anchorOffset, focus_1, selection.focusOffset)
          )
        : readRange(selection)
    }
  }
  ...
  var gatherer = function (cand, gather, isRoot) {
    return gather(cand, isRoot).bind(function (target) {
      return isText(target) && get$9(target).trim().length === 0
  ...
  var JUMP_SIZE = 5
  var NUM_RETRIES = 100
  var adt = Adt.generate([{none: []}, {retry: ['caret']}])
  ...
  var getSelectionTargets = function (editor, selections) {
    ...
    var findTargets = function () {
      return getStart().bind(function (startCellOrCaption) {
        return flatten(
          lift2(table(startCellOrCaption), getEnd().bind(table), function (startTable, endTable) {
    ...
    var setupHandler = function (handler) {
      ...
      return function () {
        changeHandlers.set(
          filter$2(changeHandlers.get(), function (h) {
            return h !== handler
          })
        )
      }
