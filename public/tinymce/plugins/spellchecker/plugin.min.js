    ...
    return {
      ...
      wrap: function (e) {
            ...
            (function (e, t, n) {
              ...
              e: for (;;) {
                if (
                  ...
                  3 === u.nodeType &&
                    (!o && u.length + l >= c.end ? ((o = u), (i = c.end - l)) : r && s.push(u),
                    !r && u.length + l > c.start && ((r = u), (a = c.start - l)),
                    (l += u.length)),
                  r && o)
                ) {
                  if (
              ...
              function (e) {
                ...
                if (t === n) {
                  var a = t,
                    i = a.parentNode
                  0 < e.startNodeIndex &&
                    ((s = o.createTextNode(a.data.substring(0, e.startNodeIndex))),
                    i.insertBefore(s, a))
                  var c = m(e.match, r)
                  return (
                    i.insertBefore(c, a),
        ...
        function m(e, t) {
          ...
          return (
            r.setAttribute('data-mce-index', '' + t), e && r.appendChild(v.doc.createTextNode(e)), r
          )
        }
        var o
      },
