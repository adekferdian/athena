...
import DeleteMasterBenefitTypeModal from '../components/DeleteMasterBenefitTypeModal'
import {deleteMasterBenefitType, getMasterBenefitTypeList} from '../redux/MasterBenefitTypeCRUD'
import {getErrorMessage} from 'src/app/utils/api-utils'
import Pagination from 'src/app/components/Pagination'

const ListMasterBenefitType: FC = () => {
  ...
  const {state, setLimit, setPage, setQuery} = usePagination<MasterBenefitType, any>(
  ...
  useEffect(() => {
    document.title = getTitle('List of Master Benefit Type')
  }, [])
  ...
  return (
    <>
      ...
      <div className='card shadow-sm'>
                  ...
                  {state.data.length === 0 ? (
                    ...
                    state.data.map((value, index) => (
                      <tr key={index}>
                        ...
                        <td className='align-middle'>{value.benefittype_id}</td>
                        <td className='align-middle'>{value.benefittype}</td>
                        ...
                        <td className='align-middle' style={{minWidth: 125}}>
                          ...
                          <button
                            ...
                            onClick={() =>
                              history.push(`/master-type-benefit/edit/${value.benefittype_id}`)
                            }
                          >
        ...
        <DeleteMasterBenefitTypeModal
          onDelete={() => {
            deleteMasterBenefitType(handleDeleteData?.benefittype_id ?? '')
              .then(() => {
