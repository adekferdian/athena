...
const DeleteMasterCampaignTypeModal: React.FC<Props> = ({show, handleClose, data, onDelete}) => {
  return (
    <Modal aria-hidden='true' tabIndex='-1' show={show} onHide={handleClose} centered>
      ...
      <div className='modal-body'>
        <div className='fv-row mb-10'>
          <div className='mb-4'>
            Are you sure want to delete <span className='fw-bolder'>{data?.campaigntype}</span> from list
            master rules?
          </div>
        </div>
      </div>
...
export default DeleteMasterCampaignTypeModal
