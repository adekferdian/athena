...
import { createMasterCampaignType } from "../redux/MasterCampaignTypeCRUD"
...
export const AddMasterCampaignType: FC = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values: any, {setStatus, setSubmitting}) => {
      ...
      setTimeout(() => {
        ...
        createMasterCampaignType(values.campaigntype, values.status)
          .then(() => {
            setLoading(false)
            setSubmitting(false)
            history.goBack()
          ...
          .catch(() => {
            setLoading(false)
            setSubmitting(false)
            setStatus('Add campaign type failed.')
          })
      }, 1000)
      setLoading(false)
    },
  ...
  //start::TITLE_FUNC
  const pageTitle = useMemo(() => MasterCampaignTypeScreens.ADD_MASTER_CAMPAIGN_TYPE.TITLE, [])
        ...
        <form className='form w-100' onSubmit={formik.handleSubmit} noValidate>
          <div className='mb-10 col'>
            <div className='col-12 col-md-6 mb-10 mb-md-0 mt-10'>
              ...
              <input
                placeholder='Input Campaign Type Name'
