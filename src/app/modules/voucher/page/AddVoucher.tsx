...
export const AddVoucher = () => {
  ...
  const renderSectionSelectPlatform = () => (
    <div className="card mb-4 py-12 px-8">
      <div className="d-flex">
        <div className="col-2 text-gray-800 fw-bold fs-6">Select Platform</div>
        <InputRadio
          label="SHOP"
  ...
  const renderSectionCampaignType = () => (
    <div className="card mb-4 py-12 px-8">
      <div className="d-flex">
        <div className="col-2 text-gray-800 fw-bold fs-6">Campaign Type</div>
        <InputRadio
          label="Voucher"
  ...
  const renderSectionIdentification = () => (
    <div className="card mb-4 p-8">
      <div className="d-flex">
        <div className="col-2 text-gray-800 fw-bold fs-6">Identification</div>
        <div className="col-8">
          <div className="mb-8">
            <InputText
              label="Campaign Name"
  ...
  const renderSectionVoucherCode = () => (
    <div className="card mb-4 py-12 px-8">
      <div className="d-flex">
        <div className="col-2 text-gray-800 fw-bold fs-6">Voucher Code</div>
        <div className="col-8">
          <div className="d-flex">
            <InputRadio
  ...
  const renderSectionValidityPeriod = () => (
    <div className="card mb-4 py-12 px-8">
      <div className="d-flex">
        <div className="col-2 text-gray-800 fw-bold fs-6">Validity Period</div>
        <div className="col-8">
  ...
  const renderSectionTargetUser = () => (
    <div className="card mb-4 py-12 px-8">
      <div className="d-flex">
        <div className="col-2 text-gray-800 fw-bold fs-6">Target User</div>
        <div className="col-10">
          ...
          {chosenUser !== 'all' && (
            <div className="col-12">
              <button
                className="d-flex align-items-center btn btn-light-secondary mb-4"
  ...
  const renderSectionImage = () => (
    <div className="card mb-4 py-12 px-8">
      <div className="d-flex">
        <div className="col-2 text-gray-800 fw-bold fs-6">Image</div>
        <div className="col-8">
          <ImageDropZone
            onDrop={() => {}}
            onClear={() => {}}
  ...
  return (
    <>
      ...
      <form className="form w-100" onSubmit={() => {}} noValidate>
