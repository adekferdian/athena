...
const ApproveCampaignModal: React.FC<Props> = ({ show, handleClose, data, onDelete }) => {
    return (
        <Modal aria-hidden='true' tabIndex='-1' show={show} onHide={handleClose} centered>
            ...
            <div className='modal-body'>
                <div className='d-flex align-items-center justify-content-center'>
                    <InlineSVG
                        src={'/media/icons/ceklissuccess.svg'}
                    // className='position-absolute translate-middle-y top-50 ms-4 pe-none'
                    />
                </div>
                <div className='d-flex align-items-center justify-content-center'>
                    <h3 className='d-flex align-items-center'>Approve Campaign</h3>
                </div>
            ...
            gender? */}
                        Apa Anda yakin akan menyetujui Campaign ini?
                        Jika iya, Campaign akan segera aktif dan tersedia di platform terpilih.
                    </div>
                </div>
                <div className='fv-row mb-10 d-flex align-items-center justify-content-center'>
                    <button
