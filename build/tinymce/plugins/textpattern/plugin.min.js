...
!(function () {
  ...
  function _(t, n, r, e) {
    ...
    n.deleteContents(),
      e &&
        !r(n.startContainer) &&
        (j(n.startContainer) && 0 === n.startContainer.data.length && t.remove(n.startContainer),
          ...
          return {
            fold: function () {
              ...
              if (t.length !== i.length)
                throw new Error(
                  'Wrong number of arguments to fold. Expected ' + i.length + ', got ' + t.length
                )
          ...
          if (
            ...
            var s = (function (a, i, u) {
              ...
              return vt(l, d - u.pattern.end.length, i).bind(function (t) {
                ...
                if (L(s))
                  return w.some({matches: [{pattern: s, startRng: r, endRng: r}], position: t})
                ...
                return (function (t, r, n, e, o, a) {
                  ...
                  return {
                    matches: e.matches.concat([{pattern: s, startRng: n, endRng: r}]),
