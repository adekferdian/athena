      ...
      onSubmit: function (e) {
        ...
        t.undoManager.transact(function () {
          ...
          return (
            ...
            e.fold(
              function () {
                t.insertContent('<pre id="__new" class="language-' + a + '">' + r + '</pre>'),
  ...
  !(function (e, n) {
    ...
    ;(window.Prism = {manual: !0}),
        ...
        return (
          ...
          (n = (function (u) {
              ...
              j = {
                    ...
                    for (s in n)
                      n.hasOwnProperty(s) &&
                        ...
                        'Object' !== (o = j.util.type(i)) || r[l(i)]
                          ? 'Array' !== o || r[l(i)] || ((r[l(i)] = !0), e(i, t, s, r))
                ...
                highlightElement: function (e, n, t) {
                  ...
                  s &&
                    ...
                    (s.className =
                      s.className.replace(c, '').replace(/\s+/g, ' ') + ' language-' + a)
                  var i,
                  ...
                  if (
                    ...
                    return j.hooks.run('complete', o), void (t && t.call(o.element))
                  j.hooks.run('before-highlight', o),
                    o.grammar
                      ? n && u.Worker
                        ? (((i = new Worker(j.filename)).onmessage = function (e) {
                            l(e.data)
                          }),
                          i.postMessage(
                            ...
                            for (
                              ...
                              if (!(w instanceof T)) {
                                ...
                                if (b) {
                                  ...
                                  for (
                                    var P = h;
                                    P !== t.tail && (F < x || 'string' == typeof P.value);
                                    P = P.next
                                  )
                                    v++, (F += P.value.length)
                                ...
                                $ && N(t, h, $),
                                  1 < v &&
                                    (e(n, t, a, h.prev, y, (C = {cause: o + ',' + u, reach: z})),
            ...
            function O(e, n, t, a) {
              ...
              var r,
                s = e.exec(t)
              return (
                s && a && s[1] && ((r = s[1].length), (s.index += r), (s[0] = s[0].slice(r))), s
              )
            }
            function s() {
            ...
            if (
              ...
              (T.stringify = function n(e, t) {
                ...
                var r = {
                  ...
                  s = e.alias
                s &&
                  (Array.isArray(s) ? Array.prototype.push.apply(r.classes, s) : r.classes.push(s)),
                  j.hooks.run('wrap', r)
                var i,
                  o = ''
            ...
            return (
              a && ((j.filename = a.src), a.hasAttribute('data-manual') && (j.manual = !0)),
              j.manual ||
                ('loading' === (t = document.readyState) || ('interactive' === t && a && a.defer)
                      ...
                      'string' == typeof p || (p.content && 'string' == typeof p.content)
                        ? ((a = f[m]),
                          ...
                          -1 < (o = s.indexOf(i)) &&
                            (++m,
                            (l = s.substring(0, o)),
                            (u = new h.Token(b, h.tokenize(r, g.grammar), 'language-' + b, r)),
          ...
          t.languages.insertBefore('cpp', 'keyword', {
            'generic-function': {
              ...
              inside: {
                function: /^\w+/,
                generic: {pattern: /<[\s\S]+/, alias: 'class-name', inside: t.languages.cpp},
              },
            },
          }),
          ...
          (function (t) {
            ...
            ;(t.languages.csharp = t.languages.extend('clike', {
              string: [
                ...
                {pattern: r(/(^|[^@$\\])<<0>>/.source, [P]), lookbehind: !0, greedy: !0},
              ...
              'class-name': [
                ...
                {pattern: r(/(\b<<0>>\s+)<<1>>/.source, [u, f]), lookbehind: !0, inside: x},
                {pattern: r(/(\bcatch\s*\(\s*)<<0>>/.source, [h]), lookbehind: !0, inside: x},
            ...
            t.languages.insertBefore('csharp', 'class-name', {
              attribute: {
                ...
                greedy: !0,
                inside: {
                  target: {pattern: r(/^<<0>>(?=\s*:)/.source, [z]), alias: 'keyword'},
                  'attribute-arguments': {
                    pattern: r(/\(<<0>>*\)/.source, [$]),
                    inside: t.languages.csharp,
                  },
          ...
          (s.languages.java = s.languages.extend('clike', {
            ...
            keyword: i,
            function: [s.languages.clike.function, {pattern: /(::\s*)[a-z_]\w*/, lookbehind: !0}],
            number:
          ...
          s.languages.insertBefore('java', 'class-name', {
            ...
            generics: {
              pattern:
                /<(?:[\w\s,.?]|&(?!&)|<(?:[\w\s,.?]|&(?!&)|<(?:[\w\s,.?]|&(?!&)|<(?:[\w\s,.?]|&(?!&))*>)*>)*>)*>/,
              inside: {'class-name': l, keyword: i, punctuation: /[<>(),.:]/, operator: /[?&|]/},
            },
            namespace: {
              pattern: RegExp(
      ...
      'object' == typeof e && void 0 !== n
        ? (n.exports = a())
        : ((t = 'undefined' != typeof globalThis ? globalThis : t || self).EphoxContactWrapper =
            a())
    window.Prism
    window.Prism = r
  })(b, m)
      ...
      (s = n).ui.registry.addToggleButton('codesample', {
        ...
        onSetup: function (t) {
          function e() {
            var e, n
            t.setActive(
              ((n = (e = s).selection.getStart()), e.dom.is(n, 'pre[class*="language-"]'))
            )
          }
          return (
            s.on('NodeChange', e),
