...
!(function () {
  ...
  function p(e, t, n) {
    ...
    return (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = t.replace(
      ...
      '%H',
      '' + f(n.getHours(), 2)
    )).replace('%M', '' + f(n.getMinutes(), 2))).replace('%S', '' + f(n.getSeconds(), 2))).replace(
      '%I',
      '' + (((n.getHours() + 11) % 12) + 1)
    ...
    c && 0 < c.length && (o = r.create('div', null)).appendChild(c[0].cloneNode(!0)),
      O.each(r.select('*', o), function (e) {
        g(e, t.getParam('template_cdate_classes', 'cdate').replace(/\s+/g, '|')) &&
          (e.innerHTML = p(t, t.getParam('template_cdate_format', t.translate('%Y-%m-%d')))),
          g(e, s(t).replace(/\s+/g, '|')) && (e.innerHTML = p(t, m(t))),
          g(
            e,
            t.getParam('template_selected_content_classes', 'selcontent').replace(/\s+/g, '|')
          ) && (e.innerHTML = a)
      }),
      d(t, o),
          ...
          var r,
            ...
            y =
              ...
              -1 === (a = n).indexOf('<html>') &&
                ...
                (i =
                  -1 === (g = (p = r).getParam('body_class', '', 'string')).indexOf('=')
                    ? g
