...
!(function () {
  ...
  var Re,
    ...
    Be = {
      ...
      oses: C([
        ...
        {name: 'ChromeOS', search: te('cros'), versionRegexes: [/.*?chrome\/([0-9]+)\.([0-9]+).*/]},
      ]),
    },
    Me = 'Firefox',
    Ee = function () {
              ...
              return (
                ...
                H(e.brands, function (n) {
                  ...
                  return w(r, function (e) {
                    ...
                    return {current: e.name, version: Oe.nu(parseInt(n.version, 10), 0)}
                  })
                })
              )
              var r
  ...
  function Bn(e, n, t) {
    if (!(T(t) || o(t) || f(t)))
      throw (
        (console.error('Invalid call to Attribute.set. Key ', n, ':: Value ', t, ':: Element ', e),
  ...
  function Hn(e, n, t) {
    if (!T(t))
      throw (
        (console.error('Invalid call to CSS.set. Property ', n, ':: Value ', t, ':: Element ', e),
    ...
    return ce(c, l)
      ...
      : nr(c).bind(function (i) {
          return nr(l).bind(function (u) {
            if (ce(i, u))
              return q.some({boxes: ((r = c), (o = l), St(Kt(i), r, o)), start: c, finish: l})
            if (le(i, u)) {
            ...
            return {
              fold: function () {
                ...
                if (e.length !== i.length)
                  throw new Error(
                    'Wrong number of arguments to fold. Expected ' + i.length + ', got ' + e.length
                  )
      ...
      mergable:
        ...
        cr(
          ...
          function (n) {
            return n.length <= 1
              ? q.none()
              : ir(u, i.firstSelectedSelector, i.lastSelectedSelector).map(function (e) {
    ...
    return e.getParam(
      ...
      (function (e) {
        ...
        if (ka(e)) {
          var t = e.dom,
            r =
              null !== (n = t.getParent(e.selection.getStart(), t.isBlock)) && void 0 !== n
                ? n
                : e.getBody(),
            o = Qr(Ve.fromDom(r))
    ...
    return (
      ...
      p.on('ObjectResizeStart', function (e) {
        ...
        m(u) &&
          ...
          (g = Ia(p)
            ? ''
            : ((o = (t = p).dom.getStyle((r = u), 'width') || t.dom.getAttrib(r, 'width')),
    ...
    return {
      ...
      transformCell: function (e, n, t) {
        var r,
          ...
          u = t(e.element, n)
        return we(
          'td' !== Ye(u) ? ((o = sr((r = u), 'td')), Rt(r, o), It(o, ln(r)), Yt(r), o) : u,
          e.isNew,
          e.isLocked
        )
      },
          ...
          var r = cn(t)
            .map(function (e) {
              return (
                !!gc(e) ||
                ((n = e),
                !!y(['br', 'img', 'hr', 'input'], Ya.property().name(n)) && 'img' !== Ye(e))
              )
              var n
            })
            .getOr(!1)
  ...
  function yc(e, n, t) {
    var r,
      ...
      l =
        ...
        q
          .from(
            null === (i = null === (u = c[r]) || void 0 === u ? void 0 : u.cells[o]) || void 0 === i
              ? void 0
              : i.element
          )
          .filter(hc)
    ...
    return (
      u.undoManager.ignore(function () {
        var e = (function (e, n, t, r, o, u) {
          ...
          a &&
            0 < t &&
            ((f = Ve.fromTag('thead')), Xt(l, f), It(f, Pc(t, n, 'sectionCells' === o ? s : 0, r)))
  ...
  function ul(e, n) {
    ...
    return {
      ...
      name: 'advanced',
      items:
        'cell' === n ? [{name: 'borderwidth', type: 'input', label: 'Border width'}].concat(t) : t,
    }
  }
  function il(u) {
    return function (t, r) {
            ...
            ;(t || Ke(c, 'scope')) &&
              ...
              A(n, function (e) {
                ...
                ;(n = l).setAttrib('scope', f.scope),
                  ...
                  Zu(s) &&
                    ((t = l).setFormat('tablecellbackgroundcolor', (r = m).backgroundcolor),
                  ...
                  !m.valign || ((i = m.valign) && s.formatter.apply('valign' + i, {}, c))
              })),
    ...
    e.close(),
      ...
      u.undoManager.transact(function () {
        ...
        i ||
            ...
            ((function (e, n, t) {
              ...
              if (
                ...
                o.getAttrib(n, 'width') && !ti(e)
                  ...
                  : (i.width = eu(t.width)),
                ti(e)
                  ? ((i['border-width'] = eu(t.border)), (i['border-spacing'] = eu(t.cellspacing)))
                  : ((u.border = t.border),
                ...
                for (var c = 0; c < n.children.length; c++)
                  Wf(o, n.children[c], {'border-width': eu(t.border), padding: eu(t.cellpadding)}),
                    ni(e) && Wf(o, n.children[c], {'border-color': t.bordercolor})
              ni(e) &&
          ...
          u.addVisual(),
          0 < ge(a) &&
            ((o = !(r = Ke(a, 'caption')) || 1 < ge(a)), Gu(u, i, {structure: r, style: o}))
      })
  }
  function vl(e, n) {
    var t,
  ...
  function yl(l, n, e, a, t) {
    ...
    ae(
      ...
      ae(
        {mceTableProps: P(vl, l, !1), mceTableRowProps: P(bl, l), mceTableCellProps: P(dl, l, a)},
        function (e, n) {
  ...
  var _l = /(\d+(\.\d+)?)%/,
      ...
      sink: function (e, n) {
        var t,
          ...
          u =
            ...
            qn(o, {position: 'fixed', left: '0px', top: '0px', width: '100%', height: '100%'}),
            Bu(o, da('blocker')),
            Bu(o, r.layerClass),
            {
              element: C(o),
      ...
      function (e, n, t, r) {
        ...
        return yc(
          I(
            Cc(n),
            function (e, n) {
              return {grid: nc(e.grid, o, n.row + e.delta, t, r.getOrInit), delta: e.delta + 1}
            },
            {grid: e, delta: 0}
          ).grid,
          o,
      ...
      function (e, n, t, r) {
        ...
        return yc(
          I(
            u,
            function (e, n) {
              return {grid: tc(e.grid, i, n.column + e.delta, t, r.getOrInit), delta: e.delta + 1}
            },
            {grid: e, delta: 0}
          ).grid,
          o[0].row,
                ...
                function (t) {
                  function e() {
                    ...
                    o
                      ...
                      : (t.setActive(z(n, e)),
                        r.set(u.formatter.formatChanged(c, t.setActive, !1, {value: l})))
                  }
                  var r = Yc(function (e) {
                      return e.unbind()
                    }),
    ...
    Wf = function (e, n, t, r) {
      if ('TD' === n.tagName || 'TH' === n.tagName) T(t) ? e.setStyle(n, t, r) : e.setStyle(n, t)
      else if (n.children) for (var o = 0; o < n.children.length; o++) Wf(e, n.children[o], t, r)
    },
  ...
  function gs(e) {
    if (0 < e.rangeCount) {
      ...
      return q.some(
        Gf(Ve.fromDom(n.startContainer), n.startOffset, Ve.fromDom(t.endContainer), t.endOffset)
      )
    }
    return q.none()
  }
  ...
  var Ys = function (e, n, t, r) {
      return pn(n)
        ...
        : ((f = n),
          ...
          H(ln(f), function (e) {
            return (
              d.selectNode(e.dom), Zf(d.getBoundingClientRect(), s, m) ? Ys(a, e, s, m) : q.none()
            )
          }))
    ...
    sm = Zt(),
    mm = Lr([{none: ['message']}, {success: []}, {failedUp: ['cell']}, {failedDown: ['cell']}]),
    dm = K(K({}, mm), {
                ...
                : er(Rs, [u, o]).fold(
                    function () {
                      return (
                        (n = u),
                        (t = (e = i).getRect(o)),
                        (r = e.getRect(n)).right > t.left && r.left < t.right ? mm.success() : c(o)
                      )
                      var e, n, t, r
                    },
                    function (e) {
                ...
                _i((u = $t.fromTable(e)), n).map(function (e) {
                  ...
                  return {
                    ...
                    downOrRightCells: N(
                      ...
                      function (e) {
                        return O(
                          e.cells.slice(t[0].column + t[0].colspan - 1, e.cells.length),
                          function (e) {
                            return e.element
                          }
                        )
                      ...
                      return function () {
                        return H(e, function (e) {
                          return (
                            ...
                            (t = e.cols),
                            (r = m),
                            ur(u, n, t, (o = g).firstSelectedSelector, o.lastSelectedSelector).map(
                              function (e) {
                                return (
                          ...
                          function () {
                            return or(m, g.firstSelectedSelector, g.lastSelectedSelector).map(
                              function (e) {
                                var n = Om(c) || i.isForward(c) ? Kf.after : Kf.before
                                return (
                                  a.setRelativeSelection(Kf.on(e.first, 0), n(e.table)),
                                  g.clear(m),
                                  nm(q.none(), !0)
                                )
                              }
                ...
                tr(e, u, f).each(function (e) {
                  ...
                  1 === o.length
                    ? ((n = o[0]),
                      ...
                      t && r && (s.selectRange(l, o, n, n), c.selectContents(n)))
                    : 1 < o.length && (s.selectRange(l, o, e.start, e.finish), c.selectContents(u))
                })
              })
          })
        }
            ...
            (A = Xc(0)),
            {
              touchEnd: function (e) {
                ...
                ;('td' !== Ye(r) && 'th' !== Ye(r)) ||
                  ((n = O.get()),
                  (t = A.get()),
                  ce(n, r) && e.timeStamp - t < 300 && (e.preventDefault(), S(r, r))),
                  O.set(r),
                  A.set(e.timeStamp)
              },
            })
    ...
    function e() {
      return Yl(tu(o), Zo(o)).bind(function (r) {
        return Wn(rt(r), Yl(Ve.fromDom(o.selection.getEnd()), Zo(o)).bind(rt), function (e, n) {
          return ce(e, n)
            ? g(r)
              ? q.some({element: (t = r), mergable: q.none(), unmergable: q.none(), selection: [t]})
              : q.some(ou(u, e, r))
            : q.none()
          var t
        }).bind(S)
            ...
            function (e, n) {
              return (
                n.isLocked &&
                  ...
                  0 === n.column
                    ? (e.onFirst = !0)
                    : n.column + n.colspan >= t.grid.columns && (e.onLast = !0)),
                e
              )
            },
      ...
      c.getParam('table_tab_navigation', !0, 'boolean') &&
        c.on('keydown', function (e) {
          ...
          ;(n = e).keyCode === Qs.TAB &&
            ...
            et(Ve.fromDom(n.shiftKey ? o.startContainer : o.endContainer), r).each(function (e) {
              n.preventDefault(),
                rt(e, r).each(i.clear),
