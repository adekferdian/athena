    ...
    u.addCommand('mceFullPageProperties', function () {
      ...
      ;(t = l = u),
        ...
        7 === (r = c.firstChild).type &&
          ((s.xml_pi = !0), (a = /encoding="([^"]+)"/.exec(r.value)) && (s.docencoding = a[1])),
            ...
            var t = e.getData(),
              n = (function (e, o, t) {
                ...
                s ||
                  ...
                  o.xml_pi
                    ? ((l = 'version="1.0"'),
                      o.docencoding && (l += ' encoding="' + o.docencoding + '"'),
                      7 !== a.type && ((a = new f('xml', 7)), c.insert(a, c.firstChild, !0)),
                      (a.value = l))
                    : a && 7 === a.type && a.remove(),
                  (a = c.getAll('#doctype')[0]),
                  o.doctype
                    ? (a ||
                        ((a = new f('#doctype', 10)), o.xml_pi ? c.insert(a, c.firstChild) : r(a)),
                ...
                w.each(c.getAll('link'), function (e) {
                  ...
                  w.each(o.stylesheets, function (e) {
                    d[e] ||
                      ((a = new f('link', 1)).attr({rel: 'stylesheet', text: 'text/css', href: e}),
                      (a.shortEnded = !0),
                      r(a)),
                      delete d[e]
                  }),
        ...
        (i = (r = (r =
          ...
          : (t.set(
              ...
              (g = e).getParam('fullpage_default_xml_pi') &&
                (p += '<?xml version="1.0" encoding="' + (b(g) || 'ISO-8859-1') + '" ?>\n'),
