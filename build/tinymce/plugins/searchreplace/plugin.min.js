...
!(function () {
  ...
  function Y(e, t, n) {
    ...
    var a = X(e, o)
    return a.length
      ? (i.addClass(X(e, o), 'mce-match-marker-selected'), e.selection.scrollIntoView(a[0]), o)
      : -1
  }
  function Z(e, t) {
    var n = t.parentNode
    ...
    function f(e) {
      ...
      r.findtext.length
        ? (o.text === r.findtext && o.matchCase === r.matchcase && o.wholeWord === r.wholewords
            ? te(i, a)
            : ((t = ee(i, a, r.findtext, r.matchcase, r.wholewords, r.inselection)) <= 0 &&
                ((n = e),
  ...
  var le,
    ...
    he = function (e, t, n) {
      for (
        var r, o, i = t.get(), a = k.toArray(e.getBody().getElementsByTagName('span')), c = 0;
        c < a.length;
        c++
      ) {
        var u = K(a[c])
        null !== u &&
          u.length &&
          (u === i.index.toString() && ((r = r || a[c].firstChild), (o = a[c].firstChild)), Q(a[c]))
      }
