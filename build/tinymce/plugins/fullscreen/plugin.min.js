  ...
  function ne(o, e, n) {
    ...
    var t,
      ...
      m =
        ...
        void 0 !==
          (a =
            '' !== (c = window.getComputedStyle(u).getPropertyValue(i)) || Pe(t) ? c : Me(u, i)) &&
        '' !== a
  ...
  var ue,
    ...
    ge = {
      browsers: y([
        ...
        {name: 'Opera', versionRegexes: [ve, /.*?opera\/([0-9]+)\.([0-9]+).*/], search: H('opera')},
        {
          name: 'Firefox',
    ...
    Ke = function (o, i) {
      ...
      function e() {
        ...
        F &&
          ...
          (e = '[' + Ve + ']'),
          D(
            (1 !== (n = t = document).nodeType && 9 !== n.nodeType && 11 !== n.nodeType) ||
        ...
        : ((n = $(
          ...
          (r = {
            scrollPos:
              ...
              (g = v.document),
              (d =
                (m = void 0 !== (f = L.fromDom(g)) ? f.dom : document).body.scrollLeft ||
