...
!(function () {
      ...
      return new I(function (e, t) {
        !(function () {
          ...
          for (
            ...
            for (
              var s = 1024 * c, f = Math.min(1024 + s, i), l = new Array(f - s), d = s, m = 0;
              d < f;
              ++m, ++d
            )
  ...
  function Y(e) {
    ...
    return n || r
      ? t(n) && t(r)
        ...
        : null
      : ((n = e.width), (r = e.height), n && r ? {w: parseInt(n, 10), h: parseInt(r, 10)} : null)
  }
  function Z(e) {
  ...
  function ue(e, t) {
    if (_e(e, t))
      return q(
        ...
        ((n = t),
        -1 !==
          f.inArray(e.getParam('imagetools_credentials_hosts', [], 'string[]'), new ye(n.src).host))
      )
    var n, r
          ...
          ce(s, t.dom).then(function (e) {
            ...
            s.windowManager.open({
              ...
              body: {
                type: 'panel',
                items: [
                  {type: 'imagetools', name: 'imagetools', label: 'Edit Image', currentState: t},
                ],
              },
              buttons: [
  ...
  var pe = tinymce.util.Tools.resolve('tinymce.util.Delay'),
    ...
    _e = function (e, t) {
      return (
        -1 !== f.inArray(e.getParam('imagetools_cors_hosts', [], 'string[]'), new ye(t.src).host)
      )
    }
