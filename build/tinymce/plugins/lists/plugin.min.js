...
!(function () {
    ...
    return (
      w(t).each(function (e) {
        var t,
          ...
          a,
          s =
            ((t = c.itemAttributes), (n = c.content), be((r = me.fromTag('li', u)), t), ke(r, n), r)
        we((o = e).list, s),
          (o.item = s),
          (a = c),
    ...
    var r,
      o = (function (e, t, n) {
        for (var r, o, i, a = [], s = 0; s < n; s++)
          a.push(
            ((o = t.listType),
            we((i = {list: me.fromTag(o, (r = e)), item: me.fromTag('li', r)}).list, i.item),
            i)
          )
        return a
  ...
  function Ot(u, c, f) {
    ...
    'false' !== l.getContentEditable(u.selection.getNode()) &&
      ...
      (t = (function (n, e, r) {
        for (
          var o, i = [], a = n.dom, t = Nt(n, e, !0, r), s = Nt(n, e, !1, r), u = [], c = t;
          c && (u.push(c), c !== s);
          c = c.nextSibling
        );
        return (
          Mt.each(u, function (e) {
            ...
            Zt.isBookmarkNode(e) && (Ut(t) || Ue(n, t) || (!t && e.parentNode === r))
              ? (o = null)
              : (o || ((o = a.create('p')), e.parentNode.insertBefore(o, e), i.push(o)),
                o.appendChild(e))
          }),
          i
        )
  ...
  function Lt(e, t, n) {
    return (
      ...
      (i = t) &&
        ...
        ((o = n),
        (r = e).getStyle(t, 'list-style-type', !0) === r.getStyle(o, 'list-style-type', !0)) &&
  ...
  function Dt(e, t, n, r) {
    ...
    for (
      n &&
      ((s = e.dom), Kt((u = o)) && s.isBlock(u.nextSibling) && !Kt(u.previousSibling) && c.next());
      (o = c[n ? 'next' : 'prev2']());
            ...
            n.execCommand('Delete'),
              ...
              Mt.each(t, function (e) {
                ...
                'LI' === (r = (t = e).parentNode).nodeName &&
                  ...
                  Ut(r) && (n = r.previousSibling) && 'LI' === n.nodeName && n.appendChild(t)
              })
          }),
          1))
    var n, r, o, i, a
