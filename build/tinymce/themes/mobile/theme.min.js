...
!(function () {
  ...
  var ln,
    ...
    wn = {
      browsers: w([
        ...
        {name: 'Opera', versionRegexes: [xn, /.*?opera\/([0-9]+)\.([0-9]+).*/], search: $('opera')},
        {
          name: 'Firefox',
      ...
      oses: w([
        ...
        {name: 'ChromeOS', search: $('cros'), versionRegexes: [/.*?chrome\/([0-9]+)\.([0-9]+).*/]},
      ]),
    },
    Sn = 'Firefox',
    On = function () {
              ...
              return (
                ...
                z(n.brands, function (e) {
                  ...
                  return F(o, function (n) {
                    ...
                    return {current: n.name, version: bn.nu(parseInt(e.version, 10), 0)}
                  })
                })
              )
              var o
  ...
  function Fe(n, e, t) {
    if (!(r(t) || d(t) || g(t)))
      throw (
        (console.error('Invalid call to Attribute.set. Key ', e, ':: Value ', t, ':: Element ', n),
            ...
            return {
              fold: function () {
                ...
                if (n.length !== u.length)
                  throw new Error(
                    'Wrong number of arguments to fold. Expected ' + u.length + ', got ' + n.length
                  )
      ...
      return (
        ...
        Z(
          10 < (e = n.errors).length
            ? e
                .slice(0, 10)
                .concat([{path: [], getErrorInfo: w('... (only showing first ten failures)')}])
            : e,
          function (n) {
                  ...
                  console.log(o, {
                    ...
                    sequence: Z(i, function (n) {
                      return T(['cut', 'stopped', 'response'], n.outcome)
                        ? '{' + n.purpose + '} ' + n.outcome + ' at (' + $o(n.target) + ')'
                        : n.outcome
                    }),
                  })
              },
  ...
  function Lr(n, e, t) {
    if (!r(t))
      throw (
        (console.error('Invalid call to CSS.set. Property ', e, ':: Value ', t, ':: Element ', n),
  ...
  function Yr(o, r) {
    ...
    return {
      set: function (n, e) {
        if (!g(e) && !e.match(/^[0-9]+$/))
          throw new Error(o + '.set accepts only positive integer values. Value was ' + e)
        var t = n.dom
        jr(t) && (t.style[o] = e + 'px')
      },
      get: n,
      ...
      y(
        {
          ...
          sketch: function (n) {
            return (
              (e = r.name), (t = r.configFields), (0, r.factory)(ya(e, t, (o = Ys(n)), [], []), o)
            )
            var e, t, o
          },
        },
  ...
  function ks(r) {
    return function (n, e) {
      return (
        Ss(n, {x: (o = (0 < r ? ss : as)(is((t = e)).x, Na(t), ja(t), Ka(t)))}), mn.some(o).map(x)
      )
      var t, o
    }
  }
  ...
  function Ds(r) {
    return function (n, e) {
      return (
        Cs(n, {y: (o = (0 < r ? ss : as)(is((t = e)).y, Ha(t), La(t), Ka(t)))}), mn.some(o).map(x)
      )
      var t, o
    }
  }
      ...
      function () {
        return [
          ...
          $f.sketch({
            ...
            components: [
              $f.parts['left-edge'](ka('<div class="${prefix}-hue-slider-black"></div>')),
              $f.parts.spectrum({
              ...
              $f.parts['right-edge'](ka('<div class="${prefix}-hue-slider-white"></div>')),
              $f.parts.thumb({
  ...
  var Hs = Wu(Jc.optional, ca),
    ...
    nf = function (n, e, t, o) {
      return Qs.sketch({dom: Ea(n, o), action: e, buttonBehaviours: co(or([Zs.config({})]), t)})
    },
  ...
  function el(n, e) {
    ...
    return {
      ...
      value: {
        config: {},
        me: ((t = n), (o = qo(e)), Ao({fields: [Lt('enabled')], name: t, active: {events: w(o)}})),
        configAsRaw: w({}),
        initialConfig: {},
        state: er,
      },
  ...
  !(function () {
    ...
    'object' == typeof qf && void 0 !== Yf
      ? (Yf.exports = e())
      : ((n = 'undefined' != typeof globalThis ? globalThis : n || self).EphoxContactWrapper = e())
  })()
  function ql(r, n) {
    return {
      uid: r.uid,
      ...
      return [
        {
          ...
          items: [
            ...
            (l = Ns({
              ...
              behaviours: or([
                Qi.config({highlightClass: ci('dot-active'), itemClass: ci('dot-item')}),
              ]),
    ...
    wd = function (n, c) {
      ...
      return (
        ...
        0 < (u = {errors: t, values: o}).errors.length
          ? ht.error(V(u.errors))
          : ((i = e),
            0 === (r = u.values).length ? ht.value(i) : ht.value(co(i, ao.apply(void 0, r))))
      )
    },
            ...
            ;(n = r),
              ...
              M(n, function (n) {
                n.getSystem().isConnected()
                  ? Te(e, n)
                  : (e.getSystem().addToWorld(n), Te(e, n), rt(e.element) && ct(n)),
                  e.syncComponents()
              })
          }),
            (o = i.element),
    ...
    Wd = wa({
      ...
      factory: function (c, n) {
        ...
        var d,
          ...
          m = $d()
        function g(r, i, u) {
          if ((void 0 === u && (u = d.HighlightSubmenu), i.hasConfigured(md) && md.isDisabled(i)))
            return mn.some(i)
          var n = a(i)
    ...
    Jd = Ao({
      fields: [
        ...
        $t(
          ...
          Nt(
            ht.value,
            Nt(ht.value, It([qt('transition', [Lt('property'), Lt('transitionClass')])]))
          )
        ),
      ],
      name: 'transitioning',
      ...
      return {
        ...
        components: [
          Qs.sketch({
            ...
            components: o
              ? [{dom: {tag: 'span', classes: [ci('styles-collapse-icon')]}}, wl(n)]
              : [wl(n)],
            action: function (n) {
              var e
  ...
  function dm(n) {
    if (0 < n.rangeCount) {
      ...
      return mn.some(
        fg(fe.fromDom(e.startContainer), e.startOffset, fe.fromDom(t.endContainer), t.endOffset)
      )
    }
    return mn.none()
  }
    ...
    var t,
      ...
      e = Ns(
        td.sketch({
          ...
          containerBehaviours: or([
            ii.config({toggleClass: ci('mask-tap-icon-selected'), toggleOnExecute: !1}),
          ]),
        })
      ),
      r =
    ...
    var o = Td(
      ...
      n = Td(
        td.sketch({
          ...
          components: [Cd(o)],
          containerBehaviours: or([
            ii.config({toggleClass: ci('android-selection-context-toolbar'), toggleOnExecute: !1}),
          ]),
        })
      ),
      r = No([])
    ...
    return {
      registerId: function (r, i, n) {
        Ee(n, function (n, e) {
          var t,
            o = void 0 !== u[e] ? u[e] : {}
          ;(o[i] = {cHandler: J.apply(void 0, [(t = n).handler].concat(r)), purpose: t.purpose}),
            (u[e] = o)
        })
      },
              ...
              function (n) {
                vr(Yn(), c, function (n) {
                  var e,
                    ...
                    r = Yn(),
                    i = n,
                    u = tg((e = {originator: a, kill: Y, prevent: Y, target: c}), (t = c))
  ...
  var rp,
    ...
    fp = Jt([{fixed: ['element', 'property', 'offsetY']}, {scroller: ['element', 'offsetY']}]),
        ...
        return (
          E.on('init', function () {
            w.init({
              editor: {
                ...
                onTouchContent: function () {
                  jo(fe.fromDom(E.editorContainer.querySelector('.' + ci('toolbar'))))
                    .bind(function (n) {
                ...
                onTapContent: function (n) {
                  ...
                  'img' === le(e)
                    ...
                    : 'a' === le(e) &&
                      w.system.getByDom(fe.fromDom(E.editorContainer)).each(function (n) {
                        cr.isAlpha(n) &&
                          (function (n) {
            ...
            var t,
              ...
              l = No([{label: 'The read only mode group', scrollable: !0, items: []}, s]),
